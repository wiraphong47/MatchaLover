...
สถานะ: ระบบสมาชิกใช้ PHP/MySQL แล้ว ส่วนตะกร้า คำสั่งซื้อและอีเมลต้องทดสอบครบก่อนใช้งานจริง
...
- ย้ายบริการสมาชิกและตะกร้า/คำสั่งซื้อจาก React มาเรียก API
- คิดราคาและคูปองฝั่ง Server; สร้าง order/items ใน transaction และป้องกันการสั่งซ้ำ
- ตั้งค่า SMTP/Composer และทดสอบ worker ส่งอีเมลบน MySQL ก่อนเปิดใช้งานจริง
