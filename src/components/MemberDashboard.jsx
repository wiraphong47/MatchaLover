...
export default function MemberDashboard({
  ...
  const totalSpent = useMemo(
    () =>
      memberOrders.reduce((sum, order) => sum + Number(order.total || 0), 0),
    [memberOrders]
  );
      ...
      <Box sx={{ maxWidth: 1180, mx: "auto" }}>
        ...
        >
          ...
          >
            <Box>
              ...
              <Typography
                variant="h1"
                sx={{
                  fontSize: { xs: 29, sm: 35, md: 46 },
                  lineHeight: 1.15,
                  mt: 0.5,
                }}
              >
                Member Portal & CDP Dashboard
              </Typography>
              <Typography
                sx={{ color: "#607159", fontSize: { xs: 16, md: 17 }, mt: 0.5 }}
              >
                ข้อมูลลูกค้า 360 องศา และประวัติการสั่งซื้อของคุณ
              </Typography>
            </Box>
            <Chip
              label="● พร้อมใช้งาน"
          ...
          <Stack
            ...
            flexWrap="wrap"
            gap={1}
            sx={{ mt: 3, pb: 2.5, borderBottom: "1px solid #e2dbcb" }}
          >
            <Button
              ...
              sx={
                tab === "profile"
                  ? { bgcolor: "#183b2a", width: { xs: "100%", sm: "auto" } }
                  : {
                      color: "#183b2a",
                      borderColor: "#cfc5b2",
            ...
            >
              ประวัติการสั่งซื้อ ({memberOrders.length})
            </Button>
          </Stack>
          <Box
            sx={{
          ...
          >
            {[
              ["สถานะสมาชิก", "VIP Green Member", "🌿"],
              ["คะแนนสะสม", `${points} Points`, "✦"],
              ["ยอดสั่งซื้อสะสม", money(totalSpent), "🛍️"],
          ...
          {tab === "profile" ? (
            ...
            >
                    ...
                    <Stack spacing={1.25}>
                      {profileRows.map(([label, value]) => (
                        ...
                        >
                          ...
                          <Typography
                            sx={{ color: "#2c4031", fontWeight: 600 }}
                          >
                            {value}
                          </Typography>
                        </Stack>
              ...
              >
                ...
                <Typography sx={{ fontSize: 25, fontWeight: 700, mt: 1 }}>
                  สิทธิพิเศษของคุณ
                </Typography>
                <Stack spacing={1.3} sx={{ mt: 2.5 }}>
                  <Typography>✓ รับแต้มทุกการสั่งซื้อ</Typography>
                  <Typography>✓ รับข้อเสนอสำหรับเมนูโปรด</Typography>
                  <Typography>✓ บันทึกที่อยู่เพื่อชำระเงินเร็วขึ้น</Typography>
                </Stack>
                <Button
                  onClick={onLogout}
                  variant="outlined"
                  sx={{ color: "#fffdf9", borderColor: "#d6dfac", mt: 3 }}
                >
                  ออกจากระบบ
                </Button>
              </Box>
